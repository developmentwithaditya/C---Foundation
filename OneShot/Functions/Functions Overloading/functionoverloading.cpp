...
int main()
{
    ...
    */
    ...
    int add_Of_Two = add(2, 4);      // This is first version of maximum() with the paramenter of 2 integers.
    int add_Of_Three = add(2, 4, 8); // This is Second version of maximum() with the paramenter of 3 integers.
